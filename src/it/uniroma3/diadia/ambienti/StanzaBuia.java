...
public class StanzaBuia extends Stanza{
	...
	public static final String DESCRIZIONE_STANZA_BUIA = "Qui c'è buio pesto! Hai bisogno del seguente oggetto per vedere: ";
	...
	public String getDescrizione() {
		if(!super.hasAttrezzo(nomeAttrezzoPerVedere))
			return DESCRIZIONE_STANZA_BUIA + nomeAttrezzoPerVedere;
